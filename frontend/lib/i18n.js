...
const AR = {
  ...
  'Profit Center':'مركز الأرباح',
  'Realized profit based on delivered orders, product costs, ads, commissions and delivery costs.':'الربح الفعلي بناءً على الطلبات المسلّمة وتكلفة المنتج والإعلانات والعمولات وتكاليف التوصيل.',
  'Add Ad Spend':'إضافة مصروف إعلاني',
  'All Stores':'كل المتاجر',
  'All Products':'كل المنتجات',
  'Currency warning':'تنبيه العملة',
  'Select one store to view valid combined financial totals.':'اختر متجراً واحداً لعرض إجماليات مالية صحيحة عند وجود أكثر من عملة.',
  'Delivered Revenue':'مداخيل الطلبات المسلّمة',
  'Net Profit':'صافي الربح',
  'Ad Spend':'الإنفاق الإعلاني',
  'Total Cost':'إجمالي التكاليف',
  'Product Cost':'تكلفة المنتج',
  'Packaging Cost':'تكلفة التغليف',
  'Agent Cost':'تكلفة الموظفين',
  'Delivery Cost':'تكلفة التوصيل',
  'All tracked costs':'جميع التكاليف المسجلة',
  'delivered orders':'طلبات مسلّمة',
  'margin':'هامش',
  'units delivered':'وحدات مسلّمة',
  'Per delivered order':'لكل طلب مسلّم',
  'Confirmation commissions':'عمولات التأكيد',
  'Seller-paid delivery only':'التوصيل الذي يتحمله البائع فقط',
  'Profit Margin':'هامش الربح',
  'CPA Confirmed':'تكلفة الطلب المؤكد',
  'CPA Delivered':'تكلفة الطلب المسلّم',
  'Product Profitability':'ربحية المنتجات',
  'Delivered revenue and tracked costs product by product.':'المداخيل المسلّمة والتكاليف المسجلة لكل منتج.',
  'Units':'الوحدات',
  'Packaging':'التغليف',
  'Margin':'الهامش',
  'Manual advertising costs used in product profitability calculations.':'تكاليف الإعلانات اليدوية المستخدمة في حساب ربحية المنتجات.',
  'Platform':'المنصة',
  'Campaign':'الحملة',
  'Amount':'المبلغ',
  'Delete':'حذف',
  'Edit Ad Spend':'تعديل المصروف الإعلاني',
  'Select Store':'اختر المتجر',
  'Select Product':'اختر المنتج',
  'Other':'أخرى',
  'Optional campaign name':'اسم الحملة (اختياري)',
  'Optional note':'ملاحظة اختيارية',
  'Ad spend added.':'تمت إضافة المصروف الإعلاني.',
  'Ad spend updated.':'تم تحديث المصروف الإعلاني.',
  'Delete this ad spend entry?':'هل تريد حذف هذا المصروف الإعلاني؟',
  'Ad spend deleted.':'تم حذف المصروف الإعلاني.',
  'No ad spend entries in this period.':'لا توجد مصاريف إعلانية في هذه الفترة.',
  'No profit data for this period.':'لا توجد بيانات أرباح لهذه الفترة.',
